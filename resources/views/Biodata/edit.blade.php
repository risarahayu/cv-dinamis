    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('biodata.update') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea type="keterangan" class="form-control" id="" aria-describedby="" placeholder="Tambahkan keterangan" name="keterangan" value="{{ $biodata->keterangan }}" required></textarea>
                <!-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> -->
            </div>
